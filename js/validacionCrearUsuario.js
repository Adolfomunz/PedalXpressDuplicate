...
document.addEventListener('input', (e) => {
  ...
  /*Validar contraseña */
  document.getElementById('idpass2').addEventListener('input', function() {
    ...
    if(pass1 !== pass2) {
        ...
        document.getElementById('idpass2').setCustomValidity('Las contraseñas no coinciden');
    } else {
        pass2Error.textContent = '';
        document.getElementById('idpass2').setCustomValidity('');
    }
});
